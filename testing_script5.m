...
robot_ur3e = UR3EC(transl(-1.0,-0.4,0), dc);
robot_ur3e2 = UR3EC(transl(-1.5,-0.4,0), dc);
robot_ur3e3 = UR3EC(transl(-2.0,-0.4,0), dc);
robot_ur3e4 = UR3EC(transl(-2.5,-0.4,0), dc);

robot_abbc = ABBC(transl(-0.5,0.8,0) * trotz(pi),dc);
robot_abbc2 = ABBC(transl(-3.0,0.4,0) * trotz(pi + pi/4),dc);
