classdef RobotBaseClassNT < handle
    %% RobotBaseClassNT The base robot class from which other UTS robot models should inherit, modified to use the notiles options because I find them really annoying.
...
%% General class for multiDOF robot simulation
        function self = RobotBaseClassNT()
            ...
            try 
                ...
                self.name = ['RobotBaseClassNT',datestr(now,'yyyymmddTHHMMSSFFF')];
